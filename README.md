...
Ever since then I've been pushing the library forward. I try not to use Claude for everything, some of the commits we share, the harder ones I just direct but I still take the time to review. The multiple spelling-mistakes... all me. I have mixed feelings on AI and I still belive that creativty is sacred but its also an undeniable tool in our belts. Use it with purpose.
